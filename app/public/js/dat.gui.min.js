...
!function(e, t) {
  ...
  return function(e) {
    ...
    var i = n(4),
      ...
      l = o(a),
      s = [ {
        litmus: l['default'].isString, conversions: {
          THREE_CHAR_HEX: {
            read: function(e) {
        ...
        litmus: l['default'].isNumber, conversions: {
          HEX: {
            read: function(e) {
        ...
        litmus: l['default'].isArray, conversions: {
          RGB_ARRAY: {
            read: function(e) {
        ...
        litmus: l['default'].isObject, conversions: {
          RGBA_OBJ: {
            read: function(e) {
    ...
    var u = /(\d+(\.\d+)?)px/,
      d = {
        makeSelectable: function(e, t) {
          ...
          var t = e,
            n = { left: 0, top: 0 };
          if (t.offsetParent) do n.left += t.offsetLeft, n.top += t.offsetTop, t = t.offsetParent; while (t);
          return n;
        }, isActive: function(e) {
    ...
    var Y = 'dg',
      ...
      oe = function ie(e) {
        ...
        }), U['default'].isUndefined(o.load) ? o.load = { preset: Q } : o.preset && (o.load.preset = o.preset), U['default'].isUndefined(o.parent) && o.hideable && ne.push(this), o.resizable = U['default'].isUndefined(o.parent) && o.resizable, o.autoPlace && U['default'].isUndefined(o.scrollable) && (o.scrollable = !0);
